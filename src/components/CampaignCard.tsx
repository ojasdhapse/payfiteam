...
import { Calendar, Target, TrendingUp, Users, Heart } from 'lucide-react';
...
const CampaignCard: React.FC<CampaignCardProps> = ({ campaign, onClick, onDonationSuccess }) => {
          ...
          <div className="space-y-4">
            ...
            {daysLeft > 0 && (
              <button
                ...
                className="w-full flex items-center justify-center space-x-2 py-2 bg-gradient-to-r from-pink-500 to-red-500 text-white rounded-lg hover:from-pink-600 hover:to-red-600 transition-all font-medium"
              >
